          ...
          ? [
              {
                ...
                kind: parsed.data.effectKind,
                name: parsed.data.effectName,
                description:
                  parsed.data.effectDescription || "Efeito especial configurado pelo Painel ADM.",
                trigger:
                  parsed.data.effectKind === "COOLDOWN_REDUCTION"
                    ? "ON_SKILL_USE"
                    : "ON_DAMAGE_DEALT",
                duration: parsed.data.effectDuration,
                power: parsed.data.effectPower,
                modifiers: {},
              },
            ]
          : [],
