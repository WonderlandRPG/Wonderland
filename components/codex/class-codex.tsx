      ...
      <article className="lore-dossier codex-dossier">
        <header className="codex-showcase">
          ...
          <div className="codex-showcase__identity">
            <span className="eyebrow">Arquivo de classe</span>
            <h2>{entry.name}</h2>
        ...
        <section>
          <div className="lore-section-title">
            <span>01</span>
            <div>
              <small>Especializações · nível 50</small>
          ...
          <div className="path-dossier-grid">
            {entry.payload.paths.map((path) => (
              <article key={path.key}>
                ...
                <div className="path-quest">
                  <small>Missão de escolha</small>
                  <b>{path.quest.title}</b>
                ...
                {path.skills.map((skill) => (
                  <div className="path-technique" key={skill.key}>
                    <small>
                    ...
                    <span>
                      {skill.cost} {entry.payload.resource.name} · CDR {skill.cooldown}
                    </span>
                  </div>
                ))}
              </article>
