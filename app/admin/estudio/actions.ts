...
function draftJsonSchema() {
  return {
    ...
    properties: {
      ...
      attribute: { type: "string", enum: ["FOR", "DEF", "RES", "INI", "INT"] },
      ...
      modifierAttribute: { type: "string", enum: ["FOR", "DEF", "RES", "INI", "INT"] },
...
export async function generateSkillWithAiAction(
  ...
  const instruction = [
    ...
    "FOR é físico; INT é mágico e fortalece cura, escudo, buff e debuff; INI controla velocidade e ordem.",
