...
(function(){
  ...
  if(!document.querySelector('link[href*="site-header.css"]')){
    const style=document.createElement("link");style.rel="stylesheet";style.href="css/site-header.css?v=2";document.head.appendChild(style);
  }
  ...
  const previous=document.querySelector("header.character-sheet-topbar,header.admin-topbar,header.shop-topbar,header.account-topbar,header.characters-topbar,.character-sheet-topbar,.admin-topbar,.shop-topbar");
