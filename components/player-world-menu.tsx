        ...
        <>
          ...
          >
            ...
            <nav className={styles.links} aria-label="Destinos do mundo">
              <small>Jornada</small>
              <Link
                aria-current={pathname === "/personagens" ? "page" : undefined}
                href="/personagens"
              >
                Jogar
              </Link>
              <Link aria-current={pathname === "/combate" ? "page" : undefined} href="/combate">
                Combate
              </Link>
              <Link aria-current={pathname === "/missoes" ? "page" : undefined} href="/missoes">
                Missões
              </Link>
              <Link href={`/personagens/${activeCharacterId}?tab=equipamentos`}>Equipamentos</Link>
              <Link aria-current={pathname === "/loja" ? "page" : undefined} href="/loja">
                Loja
              </Link>
              <Link aria-current={pathname === "/presenca" ? "page" : undefined} href="/presenca">
                Presença
              </Link>
              <Link aria-current={pathname === "/diario" ? "page" : undefined} href="/diario">
                Diário
              </Link>
              <Link
              ...
              <Link aria-current={pathname === "/ranking" ? "page" : undefined} href="/ranking">
                Ranking
              </Link>
              <Link aria-current={pathname === "/ranks" ? "page" : undefined} href="/ranks">
                Ranks
              </Link>
              <Link aria-current={pathname === "/eventos" ? "page" : undefined} href="/eventos">
                Eventos
              </Link>
              <small>Informações</small>
              <Link aria-current={pathname === "/mapas" ? "page" : undefined} href="/mapas">
                Mapa
              </Link>
              <Link aria-current={pathname === "/bestiario" ? "page" : undefined} href="/bestiario">
                Bestiário
              </Link>
              <Link
              ...
              <Link aria-current={pathname === "/perfil" ? "page" : undefined} href="/perfil">
                Minha conta
              </Link>
              {isAdmin ? (
